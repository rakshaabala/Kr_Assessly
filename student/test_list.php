...
<body>
                    ...
                    <div class="test-body">
                      ...
                      <?php if ($test['test_status'] === 'completed' && $test['total_score'] !== null): ?>
                        ...
                        <div class="submit-time">
                          <span class="badge <?php echo ($test['show_answers'] === 'yes') ? 'badge-success' : 'badge-secondary'; ?>">
                            <?php echo ($test['show_answers'] === 'yes') ? 'Answers Visible' : 'Answers Hidden'; ?>
                          </span>
                        </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      const takeTestLinks = document.querySelectorAll('a.btn-take-test[href*="take_test.php?test_id="]');
      let isNavigatingToTest = false;
      ...
      takeTestLinks.forEach(function(link) {
        link.addEventListener('click', function(event) {
          if (isNavigatingToTest) {
          ...
          Promise.resolve(requestExamFullscreen())

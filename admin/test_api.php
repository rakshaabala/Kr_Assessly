...
if (!in_array($userType, ['faculty', 'admin'], true) || $accountType !== 'admin' || $currentUserId <= 0) {
...
elseif ($action === 'host_test') {
    ...
    try {
        ...
        // Persist updated section config (questions to display / marks)
...
elseif ($action === 'update_hosted_test') {
    ...
    try {
        ...
        // Persist updated section config (questions to display / marks) on edit as well.

...
// Fetch all tests across the system for admin
if ($hostedTestId) {
    ...
    $stmt = $pdo->prepare("
        SELECT 
            ...
            CASE 
                ...
                WHEN t.created_by_type = 'faculty' THEN f.name_of_faculty
            END as creator_name,
        ...
        LEFT JOIN faculty_account f ON (t.created_by_type = 'faculty' AND t.created_by_id = f.id)
        LEFT JOIN hosted_test_students hts ON ht.id = hts.hosted_test_id
        WHERE ht.id = :hosted_test_id
        GROUP BY ht.id, t.test_name, t.test_code, t.created_by_type, f.name_of_faculty, ht.test_date, ht.start_time, ht.end_time, ht.test_duration, ht.show_answers
    ");
    ...
    // All tests across the system for admin
    $stmt = $pdo->prepare("
        SELECT 
            ht.id as hosted_test_id,
            ht.test_date,
        ...
        LEFT JOIN faculty_account f ON (t.created_by_type = 'faculty' AND t.created_by_id = f.id)
        LEFT JOIN hosted_test_students hts ON ht.id = hts.hosted_test_id
        GROUP BY ht.id, t.test_name, t.test_code, t.created_by_type, f.name_of_faculty, ht.test_date, ht.start_time, ht.end_time
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin">
              <div class="row">
                <div class="col-12">
                  ...
                  <h6 class="font-weight-normal mb-0">View and analyze test results across the system</h6>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="report-header">
                  <div>
                    ...
                    <div class="test-meta">
                      ...
                      Created by: <?php echo htmlspecialchars($testReport['creator_name']); ?>
                    </div>
                  </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="report-card">
                <h4 class="test-title">All System Tests</h4>
                ...
                <?php if (empty($testReports)): ?>
                  <div class="text-center py-5">
                    ...
                    <p class="text-muted">No tests have been created or hosted yet. Once tests are available, the reports will appear here.</p>
                  </div>
                <?php else: ?>

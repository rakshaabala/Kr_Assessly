...
$statsQuery = "
    SELECT 
        ...
        SUM(CASE WHEN hts.submit_time IS NOT NULL AND EXISTS (
            SELECT 1 FROM student_answers sa 
            WHERE sa.hosted_test_student_id = hts.id 
            AND sa.marks_obtained IS NOT NULL
        ) THEN 1 ELSE 0 END) as completed_tests,
        SUM(CASE WHEN hts.submit_time IS NULL AND CONCAT(ht.test_date, ' ', ht.end_time) > NOW() THEN 1 ELSE 0 END) as upcoming_tests,
        AVG(CASE WHEN hts.total_score IS NOT NULL THEN hts.total_score ELSE NULL END) as avg_score
        ...
        <div class="content-wrapper">
          ...
          <div class="welcome-card">
            ...
            <div class="welcome-subtitle">
              <i class="fas fa-calendar-alt"></i> <?php echo $currentDate; ?> • Ready to ace your tests today?
            </div>
          </div>
                          ...
                          <div class="test-date">
                            ...
                            <?php if ($test['submit_time'] && $test['total_score'] !== null): ?>
                              <span style="margin-left: 12px; color: #667eea; font-weight: 600;">
                                <i class="fas fa-star"></i> Score: <?php echo $test['total_score']; ?>%
                              </span>
                            <?php endif; ?>
                          </div>
                        </div>
